    ...
    describe("Recrypt", () => {
        describe("Api256", () => {
            ...
            describe("decrypt roundtrip", () => {
                ...
                it("should be able to roundtrip decrypt a level 2 encrypted value", (done) => {
                    const plaintext = api.generatePlaintext();
                    const groupKeys = api.generateKeyPair();
                    const userKeys = api.generateKeyPair();
                    const deviceKeys = api.generateKeyPair();
                ...
                it("should throw an Error instance if decrypt fails", (done) => {
                    const plaintext = api.generatePlaintext();
            ...
            describe("schnorrVerify", () => {
                it("should verify the provided signed signature", () => {
                    ...
                    expect(api.schnorrVerify(keys.publicKey, null, message, signature)).to.be.true;
...
//# sourceMappingURL=Api256Shim.test.js.map